...
import { AppService } from "./service";  // 问题集服务层
import type { IApp } from "./schema";  // 问题集模型接口
 ...
 */
export class AppControllers<T extends IApp> {
  public service: AppService<T>;  // 问题集服务实例
   ...
   */
  public constructor(service: AppService<T>, schema: Schema<T>) {
